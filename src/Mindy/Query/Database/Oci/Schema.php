...
namespace Mindy\Query\Database\Oci;
...
class Schema extends \Mindy\Query\Schema\Schema
{
    ...
    public function __construct()
    {
        if ($this->defaultSchema === null) {
            $this->defaultSchema = strtoupper($this->getConnection()->username);
        }
    }
...
EOD;
    ...
    protected function getTableSequenceName($tablename)
    {
        ...
        return $this->getConnection()->createCommand($seq_name_sql)->queryScalar();
    }
    ...
    {
        if ($this->getConnection()->isActive) {
            // get the last insert id from the master connection
            return $this->getConnection()->createCommand("SELECT {$sequenceName}.CURRVAL FROM DUAL")->queryScalar();
        } else {
