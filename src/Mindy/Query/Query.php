...
class Query implements QueryInterface
{
    ...
    /**
     * Array with key - name, and value - Connection instance
     * @var array
     */
    public $databases = [];
    ...
    public $params;
    /**
     * Raw sql generated by createCommand
     * @var string
     */
    public $rawSql;
    /**
    ...
    {
        return intval($this->queryScalar("COUNT($q)"));
    }
    ...
    public function addWhere($operator, $condition, array $params = [])
    {
        $this->where[] = [
            $operator => [
                'condition' => $condition,
